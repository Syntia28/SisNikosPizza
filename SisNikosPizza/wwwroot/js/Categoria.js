        ...
        columns: [
            {
                ...
                render: function (data) {
                    return `
                        <a href="/Categories/Edit/${data}" class="btn btn-sm btn-success text-white" style="cursor:pointer;">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="/Categories/Details/${data}" class="btn btn-sm btn-info text-white" style="cursor:pointer;">
                            <i class="bi bi-list"></i>
                        </a>
                        <a onclick=Delete("/Categories/DeleteCategory/${data}") class="btn btn-sm btn-danger text-white" style="cursor:pointer;">
                            <i class="bi bi-trash3-fill"></i>
                        </a>
                    `;
                }, width: "15%", orderable: false, searchable: false, className: "text-center"
            },
            { data: "categoriaId", width: "10%", className: "text-center" },
    ...
    swal({
        ...
        .then((borrar) => {
            if (borrar) {
                $.ajax({
                    type: "POST",
                    url: url, // Categories/DeleteCategory/3
