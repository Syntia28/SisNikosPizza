...
namespace ProyectoPruebas
{
    ...
    public class ApplicationUserTests
    {
        ...
        public void CrearUsuario_PropiedadesAsignadasCorrectamente()
        {
            ...
            Assert.AreEqual("Juan P�rez", usuario.Nombre);
        ...
        public void CrearUsuario_SinDireccionYFechaNacimiento_EsPermitido()
        {
            ...
            Assert.AreEqual("Ana L�pez", usuario.Nombre);
        }
        ...
        public void NombreUsuario_Obligatorio_DeberiaTenerValor()
        {
            ...
            // Assert
            Assert.IsFalse(nombreValido, "El campo Nombre deber�a ser obligatorio.");
        }
    }
    ...
    public class CarritoTests
    {
        ...
        public void CrearCarrito_SinUserId_DeberiaSerInvalido()
        {
            ...
            // Assert
            Assert.IsFalse(UserIdValido, "El carrito no deber�a ser v�lido sin un UserId.");
        }
    }
    ...
    public class CarritoProductoTests
    {
        ...
        public void CrearCarritoProducto_PropiedadesAsignadasCorrectamente()
        {
            ...
            cp.Producto.Descripcion = "Pizza con jam�n, pi�a y queso mozzarella";
            cp.ProductoId = 1;
            cp.CarritoId = 5002;
        ...
        public void CrearCarritoProducto_CantidadDebeSerPositiva()
        {
            ...
            // Assert
            Assert.IsFalse(cantidadValida, "La cantidad deber�a ser positiva.");
        }
    }
    ...
    public class CategoriaTests
    {
        ...
        public void CrearCategoria_NombreNoDebeSerNulo()
        {
            ...
            // Assert
            Assert.IsFalse(nombreValido, "El nombre de la categor�a no deber�a ser nulo o vac�o.");
        }
    ...
    public class DetallePedidoTests
    {
        ...
        public void CrearDetallePedido_CantidadDebeSerPositiva()
        {
            ...
            // Assert
            Assert.IsFalse(cantidadValida, "La cantidad debe ser un n�mero positivo.");
        }
    ...
    public class PedidoTests
    {
        ...
        public void EstadoPedido_DebeSerValido()
        {
            ...
            var pedido = new Pedido
            {
                EstadoPedido = "desconocido" // Valor inv�lido
            };
    ...
    public class ProductoTests
    {
        ...
        public void CrearProducto_PropiedadesAsignadasCorrectamente()
        {
            ...
            Assert.AreEqual("Electr�nica", producto.categoria.nombre);
        }
        ...
        public void Producto_StockNoDebeSerNulo()
        {
            ...
            // Assert
            Assert.IsFalse(stockValido, "El stock no debe ser nulo o vac�o.");
        }
    ...
    public class ProveedorTests
    {
        ...
        public void Proveedor_CcantidadNoDebeSerNuloNiVacio()
        {
            ...
            // Assert
            Assert.IsFalse(cantidadValida, "La cantidad no debe ser nula ni vac�a.");
        }
        ...
        public void Proveedor_NombreDebeSerValido()
        {
            ...
            // Assert
            Assert.IsTrue(nombreValido, "El nombre no debe ser nulo ni vac�o.");
        }
    ...
    public class VentaTests
    {
        ...
        public void Venta_DetallesNoDebeSerNuloNiVacio()
        {
            ...
            // Assert
            Assert.IsFalse(detallesValido, "La lista de detalles no debe estar vac�a.");
        }
